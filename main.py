...
MAX_MAZE_GRAPHICS_WIDTH = MAX_WINDOW_WIDTH - SIDEBAR_WIDTH
...
def get_user_input():
    ...
    max_maze_width = int(((MAX_MAZE_GRAPHICS_WIDTH / cell_width) - 3)/2)
    ...
    window_width = cell_width * maze_width + SIDEBAR_WIDTH
